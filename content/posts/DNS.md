...
4）本地域名服务器将得到的 IP 地址返回给操作系统，同时自己将 IP 地址缓存起来<br />5）操作系统将 IP 地址返回给浏览器，同时自己也将 IP 地址缓存起来<br />6）至此，浏览器就得到了域名对应的 IP 地址，并将 IP 地址缓存起来<br />![image.png](https://cdn.jsdelivr.net/gh/CrazyCollin/image@master/uPic/m9OZ6t.png)
<a name="yrdlj"></a>
## DNS解析器
